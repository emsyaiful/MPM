	...
	<div class="panel panel-danger">
		...
		<div class="panel-body">
			<table class="table table-bordred">
				...
				<tbody>
					@foreach($kares as $key=>$value)
						<tr>
							<td>{{ $key+1 }}</td>
							<td>{{ $value->nama_kares }}</td>
							<td class="hidden">{{ $value->id_kares }}</td>
...
<div class="modal fade" id="create" role="dialog">
	<div class="modal-dialog">
		<form action="/kares" method="POST">
		{{ csrf_field() }}
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
	        		<h4 class="modal-title custom_align" id="Heading">Create new kares</h4>
				</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="hidden" class="form-control" name="id_kares" value="id_kares" id="id_kares">
					</div>
				</div>
				<div class="modal-footer">
					<button class="btn btn-danger">Submit</button>
