				...
				<tbody>
					@foreach($statuses as $key=>$value)
						<tr>
							...
							<td class="hidden">{{ $value->id_status_dealer }}</td>
		...
		{{ csrf_field() }}
			<div class="modal-content">
				<div class="modal-header">
	        		...
	        		<h4 class="modal-title custom_align" id="Heading">Create new status</h4>
				</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="hidden" class="form-control" name="id_status_dealer" value="id_status_dealer" id="id_status_dealer">
					</div>
				</div>
				<div class="modal-footer">
					<button class="btn btn-danger">Submit</button>
	...
	<div class="modal-dialog">
		...
		{{ csrf_field() }}
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
	        		<h4 class="modal-title custom_align" id="Heading">Delete Status</h4>
				</div>
				<div class="modal-body">
					<div class="form-group">
